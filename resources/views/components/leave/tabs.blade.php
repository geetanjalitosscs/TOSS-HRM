...
<div class="hr-sticky-tabs">
    <div class="flex items-stretch border-b overflow-x-auto overflow-y-visible flex-nowrap" style="border-color: var(--border-default);">
        <!-- Apply Tab -->
        <a href="{{ route('leave.apply') }}" class="px-4 py-3 {{ $activeTab === 'apply' ? 'border-b-2' : '' }} cursor-pointer transition-all flex-shrink-0 flex items-center hr-tab-hover whitespace-nowrap" style="{{ $activeTab === 'apply' ? 'border-bottom-color: var(--color-hr-primary); background-color: var(--bg-hover); color: var(--color-hr-primary-dark); font-weight: 600;' : 'color: var(--text-primary);' }}" onmouseover="if('{{ $activeTab }}' !== 'apply') { this.style.backgroundColor='var(--bg-hover)'; this.style.color='var(--color-hr-primary)'; }" onmouseout="if('{{ $activeTab }}' !== 'apply') { this.style.backgroundColor='transparent'; this.style.color='var(--text-primary)'; }">
            <span class="text-sm" style="{{ $activeTab === 'apply' ? 'font-weight: 600; color: var(--color-hr-primary-dark);' : 'font-weight: 500; color: var(--text-primary);' }}">Apply</span>
        </a>
        
        <!-- My Leave Tab -->
        <a href="{{ route('leave.my-leave') }}" class="px-4 py-3 {{ $activeTab === 'my-leave' ? 'border-b-2' : '' }} cursor-pointer transition-all flex-shrink-0 flex items-center hr-tab-hover whitespace-nowrap" style="{{ $activeTab === 'my-leave' ? 'border-bottom-color: var(--color-hr-primary); background-color: var(--bg-hover); color: var(--color-hr-primary-dark); font-weight: 600;' : 'color: var(--text-primary);' }}" onmouseover="if('{{ $activeTab }}' !== 'my-leave') { this.style.backgroundColor='var(--bg-hover)'; this.style.color='var(--color-hr-primary)'; }" onmouseout="if('{{ $activeTab }}' !== 'my-leave') { this.style.backgroundColor='transparent'; this.style.color='var(--text-primary)'; }">
        ...
        <x-dropdown-menu 
            ...
            @endphp
            <div class="px-4 py-3 {{ $isEntitlementsActive ? 'border-b-2 border-[var(--color-hr-primary)]' : '' }} cursor-pointer transition-all flex items-center justify-between gap-2 flex-shrink-0 hr-tab-hover whitespace-nowrap" style="{{ $isEntitlementsActive ? 'background-color: var(--bg-hover); color: var(--color-hr-primary-dark); font-weight: 600;' : 'color: var(--text-primary);' }}" onmouseover="if(!{{ $isEntitlementsActive ? 'true' : 'false' }}) { this.style.backgroundColor='var(--bg-hover)'; this.style.color='var(--color-hr-primary)'; }" onmouseout="if(!{{ $isEntitlementsActive ? 'true' : 'false' }}) { this.style.backgroundColor='transparent'; this.style.color='var(--text-primary)'; }">
                <span class="text-sm flex-shrink-0" style="{{ $isEntitlementsActive ? 'font-weight: 600; color: var(--color-hr-primary-dark);' : 'font-weight: 500; color: var(--text-primary);' }}">Entitlements</span>
        ...
        <x-dropdown-menu 
            ...
            @endphp
            <div class="px-4 py-3 {{ $isReportsActive ? 'border-b-2 border-[var(--color-hr-primary)]' : '' }} cursor-pointer transition-all flex items-center justify-between gap-2 flex-shrink-0 hr-tab-hover whitespace-nowrap" style="{{ $isReportsActive ? 'background-color: var(--bg-hover); color: var(--color-hr-primary-dark); font-weight: 600;' : 'color: var(--text-primary);' }}" onmouseover="if(!{{ $isReportsActive ? 'true' : 'false' }}) { this.style.backgroundColor='var(--bg-hover)'; this.style.color='var(--color-hr-primary)'; }" onmouseout="if(!{{ $isReportsActive ? 'true' : 'false' }}) { this.style.backgroundColor='transparent'; this.style.color='var(--text-primary)'; }">

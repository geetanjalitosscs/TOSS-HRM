...
@section('body')
    <x-main-layout title="Dashboard">
        <div>
            ...
            <!-- Third Row: Job Titles Chart + Buzz Activity + Recent Performance Reviews -->
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <!-- Recent Performance Reviews Card -->
                <section class="hr-card dashboard-metric-card p-5">
                    <div class="flex flex-col h-full">
                        <div class="flex items-center justify-between mb-4">
                            <div>
                                <p class="text-xs text-[var(--text-muted)] font-medium mb-1">Recent Reviews</p>
                                <h3 class="text-xl font-bold text-[var(--text-primary)]">{{ count($recentPerformanceReviews ?? []) }} Reviews</h3>
                            </div>
                            <div class="h-12 w-12 rounded-xl bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-primary-dark)] flex items-center justify-center shadow-lg shadow-[var(--color-primary-light)]">
                                <i class="fas fa-star text-lg" style="color: var(--text-primary);"></i>
                            </div>
                        </div>
                        <p class="text-xs text-[var(--text-muted)] mb-4">Latest submitted performance reviews</p>

                        <div class="pt-4 border-t border-[var(--border-default)] flex-1 flex flex-col">
                            @if(count($recentPerformanceReviews ?? []) > 0)
                                <div class="space-y-2 overflow-y-auto employee-leave-scrollbar flex-1">
                                    @foreach($recentPerformanceReviews as $review)
                                            ...
                                            <div class="flex items-start gap-2 p-2 rounded-lg transition-all hover:bg-[var(--bg-hover)] cursor-pointer">
                                                <div class="flex-1">
                                                    ...
                                                    <div class="flex items-center gap-2 mb-1">
                                                        <span class="text-[10px] font-medium px-1.5 py-0.5 rounded" style="background-color: var(--bg-hover); color: var(--text-primary);">
                                                            {{ $review['status'] }}
                                                        </span>
                            ...
                            @else
                                <div class="flex flex-col items-center justify-center h-24 text-center">
                                    <i class="fas fa-star text-3xl mb-2 opacity-60 text-[var(--color-primary-soft)]"></i>
                                    <p class="text-xs text-[var(--text-secondary)] font-medium">No reviews submitted yet</p>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="mt-3 pt-3 border-t border-[var(--border-default)]">
                            <div class="flex justify-between items-center text-xs">
                                <span class="text-[var(--text-muted)]">View All Reviews</span>
                                <a href="{{ route('performance') }}" class="inline-flex items-center gap-1 text-[var(--color-primary)] hover:text-[var(--color-primary-soft)] font-medium">
                                    Go to Performance
                                    <i class="fas fa-arrow-right text-[10px]"></i>
                                </a>
                            </div>

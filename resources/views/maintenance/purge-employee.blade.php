    ...
    <x-main-layout title="Maintenance / Purge Records">
        ...
        <div class="hr-sticky-tabs">
            <div class="flex items-center border-b border-[var(--border-default)] overflow-y-visible">
                <x-dropdown-menu 
                    :items="[
                        ['url' => route('maintenance.purge-employee'), 'label' => 'Employee Records', 'active' => true],
        ...
        <section class="hr-card p-6">
            <h2 class="text-sm font-bold text-slate-800 flex items-baseline gap-2 mb-5">
                <i class="fas fa-user-times text-[var(--color-primary)]"></i> <span class="mt-0.5">Purge Employee Records</span>
            </h2>

    ...
    <x-main-layout title="My Info">
        <div class="flex items-stretch">
            ...
            <div class="flex-1">
                ...
                <form method="POST" action="{{ route('myinfo.photo.update') }}" enctype="multipart/form-data" class="rounded-lg shadow-sm border border-purple-100 p-4 mb-3" style="background-color: var(--bg-card);">
                    @csrf
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <div class="flex-shrink-0">
                            ...
                            >
                                ...
                                @endif
                                <i class="fas fa-user text-4xl employee-photo-icon" style="color: var(--text-muted); {{ !empty($employee->photo_url) ? '' : 'display: none;' }}"></i>
                        ...
                        <div class="flex-1 flex items-center justify-end">
                            <button type="submit" class="hr-btn-primary px-4 py-2 text-xs bg-green-600 hover:bg-green-700 focus:ring-green-500">
                                Update Photo
                            </button>
                        </div>
                    </div>

...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>TOAI HRM Suite - @yield('title', 'Dashboard')</title>
        ...
        @vite(['resources/css/app.css', 'resources/css/theme.css', 'resources/css/global-ui.css', 'resources/css/components.css', 'resources/js/app.js'])
        @else

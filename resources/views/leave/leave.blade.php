                        ...
                        <div class="bg-purple-50/30 rounded-lg p-3 mb-3 border border-purple-100">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="date" value="2026-01-16" class="hr-input w-full px-2 py-1.5 text-xs border border-purple-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--color-hr-primary)] focus:border-[var(--color-hr-primary)] bg-white pr-8">
                                        <i class="fas fa-calendar-alt absolute right-3 top-1/2 transform -translate-y-1/2 text-purple-400 text-sm pointer-events-none"></i>
                                    </div>
                                </div>
                                <div>
                                    <label class="block text-xs font-medium text-slate-700 mb-1">To Date</label>
                                    <div class="relative">
                                        <input type="date" value="2026-12-31" class="w-full px-3 py-2.5 text-sm border border-purple-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--color-hr-primary)] focus:border-[var(--color-hr-primary)] bg-white pr-8">
                                        <i class="fas fa-calendar-alt absolute right-3 top-1/2 transform -translate-y-1/2 text-purple-400 text-sm pointer-events-none"></i>
                                    </div>
                                </div>
                                <div>

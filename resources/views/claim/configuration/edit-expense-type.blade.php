...
@section('title', 'Claim - Configuration - Edit Expense Type')
    ...
    <x-main-layout title="Claim">
        ...
        <div>
            <section class="hr-card p-6">
                <h2 class="text-sm font-bold flex items-baseline gap-2 mb-5" style="color: var(--text-primary);">
                    ...
                    <span class="mt-0.5">Edit Expense Type</span>
                </h2>

                <form id="editExpenseTypeForm" class="space-y-6" novalidate>
                    <!-- Name -->
                    <div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            style="border-color: var(--border-strong);background-color: var(--bg-input);color: var(--text-primary);"
                        >{{ $expenseType->description ?? '' }}</textarea>
                    </div>

                    <!-- Active Toggle -->
                    <div class="flex items-center gap-3">
                        <x-admin.toggle-switch
                            id="expenseTypeActive"
                            :checked="($expenseType->status ?? 'Active') === 'Active'"
                        />
                        <label for="expenseTypeActive" class="text-xs font-medium cursor-pointer" style="color: var(--text-primary);">Active</label>
                    </div>
        ...
        <script>
            (function () {
                ...
                const updateBtn = document.getElementById('expenseTypeUpdateBtn');

                ...
                <form action="{{ route('login.post') }}" method="POST" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between text-sm pt-1">
                        <label class="inline-flex items-center gap-2 cursor-pointer transition-all duration-300 hover:scale-105">
                            <input type="checkbox" class="h-4 w-4 rounded cursor-pointer transition" style="border: 1.5px solid var(--border-default); accent-color: var(--color-primary);" />
                        ...
                        <a href="#" class="font-semibold text-sm transition-all duration-300 hover:scale-105" style="color: var(--color-primary);" onmouseover="this.style.color='var(--color-primary-dark)'; this.style.transform='translateY(-1px)'" onmouseout="this.style.color='var(--color-primary)'; this.style.transform='translateY(0)'">
                            Forgot password?
                        </a>
                    </div>

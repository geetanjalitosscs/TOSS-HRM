...
@section('body')
    <x-main-layout title="Time / Reports / Employee Reports">
        <!-- Top Navigation Tabs -->
        ...
        <div class="flex justify-center mt-4">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 w-full max-w-4xl">
                <h2 class="text-lg font-bold text-slate-800 mb-4">Employee Reports</h2>
                <div class="border-b border-gray-200 mb-6"></div>
                
                <p class="text-sm text-slate-600">Employee reports page content will be implemented here.</p>
            </div>
        </div>
